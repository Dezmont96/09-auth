...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)"); // Хук для отримання параметрів з URL
...
const NoteDetailsClient = ()=>{
    ...
    const { data: note, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        // queryFn виконується тільки тоді, коли 'enabled' === true.
        // В цей момент ми впевнені, що 'id' - це рядок.
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchNoteById"])(id),
        enabled: !!id
    });
    ...
    // Обробка помилки або випадку, коли нотатку не знайдено
    if (isError || !note) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a99dc03._.js.map