...
function ModalNotePreview({ id }) {
    ...
    // Функція закриття для передачі в Modal
    const handleClose = ()=>{
        router.back();
    };
    let content;
    ...
    // 3. Компонент сам рендерить Modal і передає йому onClose
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c3b21b4._.js.map