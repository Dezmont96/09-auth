...
function ModalNotePreview(t0) {
    ...
    if ($[0] !== "fd16923ab84980f8d79c185e4a5e1068dbab8e62fc0064f4f1b2c1bf26455505") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fd16923ab84980f8d79c185e4a5e1068dbab8e62fc0064f4f1b2c1bf26455505";
    }
    const { id } = t0;
    let t1;
    let t2;
...
_s(ModalNotePreview, "AJJhtuyURYYBxjgsgYy7ViP3LH4=", false, function() {
    return [
...
//# sourceMappingURL=_2d1485cf._.js.map