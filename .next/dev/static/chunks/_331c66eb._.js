...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Modal$2f$Modal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/Modal/Modal.tsx [app-client] (ecmascript)"); // Імпортуємо Modal
...
function ModalNotePreviewClient(t0) {
    ...
    if ($[0] !== "589dc0ccd30dc7e1fe17dc68a806be5c7d514049b27991c1bedac51d071f8a01") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "589dc0ccd30dc7e1fe17dc68a806be5c7d514049b27991c1bedac51d071f8a01";
    }
    const { id } = t0;
...
_s(ModalNotePreviewClient, "4Q7UPRW1Yth5LdvPWFBQNoHRTxo=", false, function() {
    return [
...
//# sourceMappingURL=_331c66eb._.js.map