...
function SignInPage() {
    ...
    if ($[0] !== "32dbf10522bd4b51672a2ddfde76617b29d5feac7226f816a3ffec90c72ee17d") {
        for(let $i = 0; $i < 21; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "32dbf10522bd4b51672a2ddfde76617b29d5feac7226f816a3ffec90c72ee17d";
    }
    ...
    if ($[5] !== t0) {
        t2 = {
            mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"],
            onSuccess: t0,
            onError: t1
        };
        $[5] = t0;
    ...
    const t7 = mutation.isPending ? "Logging in..." : "Log in";
    let t8;
...
_s(SignInPage, "VseeYF0IxfpU0VDfSFk/H5YImbM=", false, function() {
    return [
