...
function FilteredNotesClient(t0) {
    ...
    if ($[0] !== "bde684331d4fdcf4ba510bb0427e94f5ea21dfa4f9ea8eafbac9c509133886f0") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bde684331d4fdcf4ba510bb0427e94f5ea21dfa4f9ea8eafbac9c509133886f0";
    }
    const { notes } = t0;
    let t1;
    if ($[1] !== notes) {
...
//# sourceMappingURL=_84859133._.js.map