...
const Modal = (t0)=>{
    ...
    if ($[0] !== "cd70d4f70c44e3a705b39612a05376df500063c73903b413955a1df167327332") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cd70d4f70c44e3a705b39612a05376df500063c73903b413955a1df167327332";
    }
    ...
    let t6;
    if ($[11] !== portalNode || $[12] !== t5) {
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(t5, portalNode);
        $[11] = portalNode;
        $[12] = t5;
        $[13] = t6;
    } else {
...
_s(Modal, "RFImm+EuWCdF9gTeRNMrIZMTdTE=");
_c = Modal;
...
const NoteSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"]().shape({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().min(3, 'Too Short!').max(50, 'Too Long!').required('Required'),
    content: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$yup$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"]().max(500, 'Too Long!'),
...
const NoteForm = (t0)=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "37ed97676e7a42745d2e7602c77671180f8c28122e5daa9dbd7fea69630977d6") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "37ed97676e7a42745d2e7602c77671180f8c28122e5daa9dbd7fea69630977d6";
    }
    const { onSuccess, onCancel } = t0;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
    if ($[1] !== onSuccess || $[2] !== queryClient) {
        t1 = {
            mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNote"],
            onSuccess: ()=>{
    ...
    const createNoteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(t1);
    let t2;
    if ($[4] !== createNoteMutation) {
        t2 = (values, t3)=>{
            const { setSubmitting } = t3;
    ...
    let t4;
    if ($[7] !== createNoteMutation.error || $[8] !== createNoteMutation.isError || $[9] !== onCancel) {
        t4 = (t5)=>{
            const { isSubmitting } = t5;
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$formik$2f$dist$2f$formik$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Form"], {
                ...
                children: [
                    ...
                    createNoteMutation.isError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteForm$2f$NoteForm$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].error,
        ...
        $[7] = createNoteMutation.error;
        $[8] = createNoteMutation.isError;
        $[9] = onCancel;
        $[10] = t4;
    } else {
        t4 = $[10];
...
_s(NoteForm, "SWcgb/4V5OsFERttGio0DfMv8e8=", false, function() {
    return [
...
const Pagination = (t0)=>{
    ...
    if ($[0] !== "6a943cb215a0d0c7f42286e6b58118c36b8ce88d13c85ddc86b46b8bbabba60e") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "6a943cb215a0d0c7f42286e6b58118c36b8ce88d13c85ddc86b46b8bbabba60e";
    }
    ...
    if ($[1] !== onPageChange || $[2] !== pageCount || $[3] !== t1) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$paginate$2f$dist$2f$react$2d$paginate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            previousLinkClassName: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Pagination$2f$Pagination$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].pageLink,
            nextLinkClassName: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Pagination$2f$Pagination$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].pageLink,
            activeLinkClassName: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Pagination$2f$Pagination$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].activeLink,
            disabledLinkClassName: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Pagination$2f$Pagination$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].disabledLink
        }, void 0, false, {
...
const NoteList = (t0)=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "d60462ed816664bbd6c2f1a7aea3467a66f7d5945a851aa98730e19629838659") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "d60462ed816664bbd6c2f1a7aea3467a66f7d5945a851aa98730e19629838659";
    }
    const { notes } = t0;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
    if ($[1] !== queryClient) {
        t1 = {
            mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteNote"],
            onSuccess: ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
                        "notes"
...
const NotesClient = ()=>{
    ...
    if ($[0] !== "08574d4210e35c3e6634461fb04f13fc96b3e3baf984d66f84eeeb8756c44462") {
        for(let $i = 0; $i < 39; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "08574d4210e35c3e6634461fb04f13fc96b3e3baf984d66f84eeeb8756c44462";
    }
    ...
    let t0;
    if ($[1] !== currentPage || $[2] !== debouncedSearchTerm) {
        t0 = {
            queryKey: [
                "notes",
                currentPage,
            ...
            queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNotes"])({
                    page: currentPage,
    ...
    const { data, isLoading, isError, isPlaceholderData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t0);
    let t1;
    ...
    let t12;
    if ($[24] !== data || $[25] !== isError || $[26] !== showLoader) {
        t12 = data && data.notes && data.notes.length === 0 && !showLoader && !isError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            style: {
                textAlign: "center"
            },
    ...
    if ($[28] !== t10 || $[29] !== t11 || $[30] !== t12 || $[31] !== t9) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$NotesPage$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].content,
            children: [
                t9,
                t10,
                t11,
...
_s(NotesClient, "qhvMoFClJ0hMj+D7P0+faPH9WEw=", false, function() {
    return [
...
//# sourceMappingURL=_1cb6e00a._.js.map