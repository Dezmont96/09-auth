...
"[project]/lib/api/index.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-client] (ecmascript)"); // Хук для отримання параметрів з URL
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/index.ts [app-client] (ecmascript)");
...
;
;
// Можна передавати id через пропси або використовувати useParams.
// Використаємо useParams, як вказано в ТЗ.
const NoteDetailsClient = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(22);
    if ($[0] !== "2c58f19fd95be89926ee1e0b1595784d73db70705ac97d0abcebb55dd2793334") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2c58f19fd95be89926ee1e0b1595784d73db70705ac97d0abcebb55dd2793334";
    }
    ...
    if ($[1] !== id) {
        ...
        t1 = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchNoteById"])(id);
        $[1] = id;
        $[2] = t0;
        $[3] = t1;
    } else {
    ...
    const { data: note, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t3);
    if (isLoading) {
        let t4;
    ...
    if (isError || !note) {
        ...
        if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ErrorMessage$2f$ErrorMessage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                children: "Something went wrong. Could not find the note."
            }, void 0, false, {
                fileName: "[project]/app/notes/[id]/NoteDetails.client.tsx",
                lineNumber: 68,
                columnNumber: 12
    ...
    let t6;
    if ($[14] !== note.createdAt) {
        t6 = new Date(note.createdAt).toLocaleString();
        $[14] = note.createdAt;
        $[15] = t6;
    } else {
        t6 = $[15];
...
_s(NoteDetailsClient, "GCG7+mh/gTT81+lCuIi0DVk7Z+U=", false, function() {
    return [
...
//# sourceMappingURL=_258cabd9._.js.map